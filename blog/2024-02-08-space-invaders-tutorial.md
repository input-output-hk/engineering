...
The Yampa library in Haskell (https://hackage.haskell.org/package/Yampa) is based on Functional Reactive Programming (FRP) for modelling programs as events and time-varying values. FRP is useful in the domain of UIs and games because the encoding of events helps with handling user inputs and outputs.
...
```
<script src="dist-newstyle/build/javascript-ghcjs/ghc-9.8.1/SpaceInvaders-0.14.2/x/jsBuild/build/jsBuild/jsBuild.jsexe/all.js"></script>
```
